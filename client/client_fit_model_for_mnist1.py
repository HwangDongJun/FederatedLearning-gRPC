...
class learning_fit(object):
	...
	def generate_datasets(self):		
		...
		if self.random_choice_list == list():
			...
			#self.random_choice_list = list(set([random.randint(0, 5999) for r in range(1000)]))
			self.random_choice_list = list(range(0, 5999))
		
		'''
		with open('./save_random_data/random_choice1_newloss.pickle', 'wb') as fw:
			pickle.dump(self.random_choice_list, fw)
		with open('./save_random_data/hete_list1_newloss.pickle', 'wb') as fw:
			pickle.dump(sample_hete_list, fw)
		
		with open('./save_random_data/random_choice1.pickle', 'rb') as fr:
			self.random_choice_list = pickle.load(fr)
		with open('./save_random_data/hete_list1.pickle', 'rb') as fr:
