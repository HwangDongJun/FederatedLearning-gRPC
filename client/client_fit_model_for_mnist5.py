...
class learning_fit(object):
	...
	def generate_datasets(self):		
		...
		#hete_count_choice = random.choice([0, 0, 1, 1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 4, 4, 5, 5sssssssssssssss])
		...
		sample_hete_list = [3, 5, 8]
		#sample_hete_list = [0, 1, 2, 3, 4, 5, 6, 8, 9]
		if self.random_choice_list == list():
			#self.random_choice_list = list(set([random.randint(10, 59999) for r in range(random.choice(list(set([random.randint(1097, 39999) for r in range(30)]))))]))
			#self.random_choice_list = list(set([random.randint(24000, 29999) for r in range(1000)]))
			#self.random_choice_list = list(range(24000, 29999))
			self.random_choice_list = list(range(30000,54999))
		'''	
		with open('./save_random_data/random_choice5_newloss.pickle', 'wb') as fw:
			pickle.dump(self.random_choice_list, fw)
		with open('./save_random_data/hete_list5_newloss.pickle', 'wb') as fw:
			pickle.dump(sample_hete_list, fw)
		
		with open('./save_random_data/random_choice5.pickle', 'rb') as fr:
			self.random_choice_list = pickle.load(fr)
		with open('./save_random_data/hete_list5.pickle', 'rb') as fr:
		...
		# new data --> class
		self.random_choice_list = list()
		sample_hete_list = [0, 1, 2, 4, 6, 7, 9]
		if self.random_choice_list == list():
			self.random_choice_list = list(range(23000, 24999))
	...
	def manage_train(self, params=None, cr=None, cn=None, state=None): # cr:current_round
		...
		with open('./saved_weight/weights5.pickle', 'wb') as fw:
