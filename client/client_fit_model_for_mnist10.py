...
class learning_fit(object):
	...
	def generate_datasets(self):		
		...
		sample_hete_list = [0, 2, 3, 4, 6, 7]
		if self.random_choice_list == list():
			#self.random_choice_list = list(set([random.randint(10, 59999) for r in range(random.choice(list(set([random.randint(2000, 59999) for r in range(30)]))))]))
			#self.random_choice_list = list(set([random.randint(54000, 59999) for r in range(10000)]))
			self.random_choice_list = list(range(54000, 59999))
		'''	
		with open('./save_random_data/random_choice10_newloss.pickle', 'wb') as fw:
			pickle.dump(self.random_choice_list, fw)
		with open('./save_random_data/hete_list10_newloss.pickle', 'wb') as fw:
			pickle.dump(sample_hete_list, fw)
		
		with open('./save_random_data/random_choice10.pickle', 'rb') as fr:
			self.random_choice_list = pickle.load(fr)
		with open('./save_random_data/hete_list10.pickle', 'rb') as fr:
		...
		if self.random_choice_list == list():
			self.random_choice_list = list(range(33950, 54271))
		...
		self.random_choice_list = list()
		sample_hete_list = [0, 1, 2, 5, 6, 7, 8, 9]
		if self.random_choice_list == list():
			self.random_choice_list = list(range(42561, 44858))
