...
class learning_fit(object):
	...
	def gen_train_val_data(self, ims=(96, 96), cn=np.array(['0', '1', '2', '3', '4']), crr=None):
		...
		train_data_dir = None
		if crr <= 40:
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client2_211103/')
		elif crr > 40 and crr < 140:
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client2_211104/')
		elif crr >= 140:
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client2_211109/')
	...
	def manage_train(self, params=None, cr=None, cn=None, state=None): # cr:current_round
		...
		#data_size = {0: 480, 1: 507, 2: 469, 3: 431, 4: 378}
