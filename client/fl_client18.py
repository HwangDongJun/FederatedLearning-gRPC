...
#from client_fit_model1 import learning_fit
from client_fit_model_for_mnist18 import learning_fit
...
#ready_info_dict['gl'] = rs.ready_rep.config['model_loss'].scfloat
	...
	if ready_state:
		...
		for ru in response_update:
			class_for_learning = learning_fit(ready_info_dict['tmt'], 20, 32, ru.update_rep.buffer_chunk, ready_info_dict['cr'])
		...
		while ready_info_dict['cr'] <= ready_info_dict['mtr']:
			...
			with open('./saved_weight/weights18.pickle', 'rb') as fr:
