...
class learning_fit(object):
	...
	def gen_train_val_data(self, ims=(96, 96), cn=np.array(['0', '1', '2', '3', '4']), crr=None):
		...
		train_data_dir = None
		if crr < 20: # 3
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client8_211103/')
		elif crr >= 20 and crr < 40: # 4
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client8_211104/')
		elif crr >= 40 and crr < 100: # 5
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client8_211105/')
		elif crr >= 100: # 7
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client8_211107/')
	...
	def manage_train(self, params=None, cr=None, cn=None, state=None): # cr:current_round
		...
		#data_size = {0: 207, 1: 261, 2: 41, 3: 76, 4: 87}
