...
class learning_fit(object):
	...
	def generate_datasets(self):		
		...
		if self.random_choice_list == list():
			...
			#self.random_choice_list = list(set([random.randint(18000, 23999) for r in range(1000)]))
			self.random_choice_list = list(range(18000, 23999))
		'''	
		with open('./save_random_data/random_choice4_newloss.pickle', 'wb') as fw:
			pickle.dump(self.random_choice_list, fw)
		with open('./save_random_data/hete_list4_newloss.pickle', 'wb') as fw:
			pickle.dump(sample_hete_list, fw)
		
		with open('./save_random_data/random_choice4.pickle', 'rb') as fr:
			self.random_choice_list = pickle.load(fr)
		with open('./save_random_data/hete_list4.pickle', 'rb') as fr:
		...
		# new data --> class
		self.random_choice_list = list()
		sample_hete_list = [0, 1, 2, 3, 4, 5, 6, 7, 8]
		if self.random_choice_list == list():
			self.random_choice_list = list(range(20000, 22999))
