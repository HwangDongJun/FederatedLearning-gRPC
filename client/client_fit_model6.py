...
class learning_fit(object):
	...
	def gen_train_val_data(self, ims=(96, 96), cn=np.array(['0', '1', '2', '3', '4']), crr=None):
		...
		train_data_dir = None
		if crr < 160:
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client6_211103/')
		elif crr >= 160:
			train_data_dir = os.path.abspath('/home/dnlab/FederatedLearning-gRPC/client/save_data/client6_211110/')
	...
	def manage_train(self, params=None, cr=None, cn=None, state=None): # cr:current_round
		...
		#data_size = {0: 81, 1: 219, 2: 174, 3: 132, 4: 0}
